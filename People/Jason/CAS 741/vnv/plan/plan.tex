...
artifacts should be tested against the manually created artifacts for nontrivial
or significant differences (to assure there are none\footnote{Unless the
manually created artifacts had problems, of course.}). Additionally, as Drasil
does not yet generate unit tests\footnote{But Sam might fix this for us!}, the
unit tests will be performed on the generated software artifacts with a bit of
manual effort to ensure compatibility.

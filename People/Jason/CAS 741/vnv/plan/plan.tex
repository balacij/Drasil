...
Validation (VnV) of the Beam Bending analysis program (\progname{}).

\plt{provide an introductory blurb and roadmap of the Verification and
    Validation plan}
...
\plt{Introduce this section. You can provide a roadmap of the sections to come.}
...
\begin{longtable}{|l|c|l|}
    ...
    Sam Crawford         & \(*\)                             & Reviewer and VnV-er.                                          \\ \hline
...
\begin{longtable}{|l|p{8cm}|}
    ...
    Authoritative Expert & Manager of all review committees and distinguished reviewer. \\ \hline
    Domain Expert        &                                                              \\ \hline
    Author               &                                                              \\ \hline
    Reviewer             &                                                              \\ \hline
    Verifier             &                                                              \\ \hline
...
The onus of Drasil's validation is up to the Drasil team.

\an{Well, I am extending Drasil a bit.}

\subsection{Verification and Validation Plan Verification Plan}

\plt{The verification and validation plan is an artifact that should also be
    verified.}

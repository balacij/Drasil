...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{diagrams/beam_bending_diagram.drawio.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{diagrams/beam_bending_diagram_annotated.drawio.png}

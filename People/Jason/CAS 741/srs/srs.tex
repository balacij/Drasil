...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{| p{\colAwidth} | p{\colBwidth}|}
        \hline
        \rowcolor[gray]{0.9}
        Number      & DD\refstepcounter{datadefnum}\thedatadefnum \label{dd_loading_function} \\
        \hline
...
\gsref{deflection} and \gsref{reaction} are solved by \iref{im_deflection} and
\iref{im_reaction}.
...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{| p{\colAwidth} | p{\colBwidth}|}
        ...
        Description & $L_B$ is the beam's length.                                            \\
                    ...
                    & $y_{B}(x)$ is a function describing the deflection along the beam.     \\
        \\
        \hline
        Sources     & \nc{}                                                                  \\
        \hline
...
\begin{table}[!h]
    ...
    \noindent \begin{longtable*}{l l}
        ...
        \midrule
        $y_{B}(x)$ & $\forall~x \in [0, L]~.~|y_{B}(x)| \leq \frac{L}{10}$ (by~\aref{beam_deflection})
        \\
        \bottomrule
    \end{longtable*}
\end{table}
...
\noindent\begin{itemize}
    ...
    \item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR_Accuracy}:]
        ...
        Section~X\an{Link to the VnV plan.} of the Verification and
        Validation Plan.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
                         & \tref{T_COE} & \dref{ROCT} & \ddref{FluxCoil} & \iref{ewat} \\ \hline
        \tref{T_COE}     &              &             &                  &             \\ \hline
        \dref{NL}        &              &             &                  &             \\ \hline
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        \hline
                           & \iref{ewat} & \ref{sec_DataConstraints} & \rref{R_RawInputs} \\ \hline
        \iref{ewat}        &             &                           &                    \\ \hline
